...
class PedidoE2ETest {
    ...
    void setUp() {
        ...
        E2ETestData.ensurePedido(tiendaRepository, pedidoRepository);
    ...
    void crearPedido() {
        ...
        driver.get(appUrl + "/pedidos/nuevo");
    ...
    void editarPedido() {
        ...
        driver.get(appUrl + "/pedidos");
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href*='/pedidos/editar/']")));
    ...
    void eliminarPedido() {
        ...
        driver.get(appUrl + "/pedidos");
        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href*='/pedidos/eliminar/']")));
